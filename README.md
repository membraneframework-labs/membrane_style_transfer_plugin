...
def deps do
  [
    {:membrane_style_transfer_plugin, "~> 0.1.0"}
  ]
end
```
...
Copyright 2020, [Software Mansion](https://swmansion.com/?utm_source=git&utm_medium=readme&utm_campaign=membrane_style_transfer_plugin)
